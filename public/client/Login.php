<?php
        ...
        $title = 'ĐĂNG NHẬP | '.$NDVMEDIA->site('tenweb');
    ...
    <div class="container SW-container">
        ...
        <form class="form">
            ...
            <input type="password" placeholder="Nhập mật khẩu" id="password" autocomplete="off">
               <button class="SW-button" type="button" id="Login">Đăng Nhập</button>
        </form>
        <span class="change-form-btn"> Chưa có tài khoản ?
                            <a href="/Auth/Registers"> Đăng ký tại đây </a>
                        </span>
    </div>
</div>
</div>
