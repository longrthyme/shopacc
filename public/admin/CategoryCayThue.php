<?php
    ...
    $title = 'QUẢN LÝ CHUYÊN MỤC CÀY THUÊ | '.$NDVMEDIA->site('tenweb');
...
if(isset($_POST['ThemChuyenMuc']) && $getUser['level'] == 'admin' )
{
    ...
    $NDVMEDIA->insert("category_caythue", array(
        ...
        <div class="content-wrapper">
          <div class="row">
           <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">THÊM DANH MỤC CÀY THUÊ</h4>
           ...
           <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">DANH SÁCH CHUYÊN MỤC CẦY THUÊ</h4>
                  <p class="card-description">
                        ...
                        <div class="table-responsive">
                            <table id="datatable1" class="table table-bordered table-striped table-hover">
                                ...
                                <tbody>
                                    <?php
                                    $i = 0;
                                    foreach($NDVMEDIA->get_list(" SELECT * FROM `category_caythue` ORDER BY id DESC ") as $row){
                                    ?>
                                    <tr>
                                        <td><?=$i++;?></td>
