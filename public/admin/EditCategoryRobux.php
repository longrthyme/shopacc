<?php
   require_once("../../display/config.php");
    ...
    $title = 'CHỈNH SỬA CATEGORY ROBUX | '.$NDVMEDIA->site('tenweb');
...
if(isset($_POST['LuuChuyenMuc']) && $getUser['level'] == 'admin' )
{
    ...
    if(check_img('img') == true)
    {
        ...
        $NDVMEDIA->update("category_robux", array(
                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="footer">
                                ...
                                <a type="button" class="btn btn-secondary"
                                    href="<?=BASE_URL('Admin/Category/Robux/');?>">QUAY LẠI</a>
                            </div>
                        </form>
                    </div>
                </div>
