...
if(isset($_POST['Save']) && $getUser['level'] == 'admin' )
{
    ...
    $row = $NDVMEDIA->get_row("SELECT * FROM `orders_gamepass` WHERE `id` = '$id' ");
    if(!$row)
    {
    ...
    $NDVMEDIA->update("orders_gamepass", array(
        'status' => $status,
        'reason' => $reason
    ), " `id` = '".check_string($_POST['id'])."' ");
        ...
        <div class="content-wrapper">
          <div class="row">
           <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">GAMEPASS ĐANG CÀY</h4>
                  ...
                  <div class="table-responsive">
                            <table id="datatable1" class="table table-bordered table-striped table-hover">
                                ...
                                <tbody>
                                    <?php
                                    $i = 0;
                                    foreach($NDVMEDIA->get_list(" SELECT * FROM `orders_gamepass` WHERE `status` = 'dangcay' ORDER BY id DESC ") as $row){
                                    ?>
                                    <tr>
                                        <td><?=$i++;?></td>
                                        <td><?=$row['receiver'];?></td>
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <textarea name="reason" id="reason" placeholder="Nhập lý do nếu có" class="form-control"></textarea>
                        </div>
                    </div>
