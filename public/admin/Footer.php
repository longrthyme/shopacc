...
<!-- content-wrapper ends -->
        ...
        <footer class="footer">
          <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2024 Verison <?=$config['version'];?> <a href="https://t.me/fuong_net" target="_blank">BÙI THANH PHƯƠNG</a>. All rights reserved.</span>
  ...
  <!-- plugins:js -->
  <script src="/themendv/vendors/js/vendor.bundle.base.js"></script>
  <!-- endinject -->
  <!-- Plugin js for this page -->
  <script src="/themendv/vendors/chart.js/Chart.min.js"></script>
  <script src="/themendv/vendors/datatables.net/jquery.dataTables.js"></script>
  <script src="/themendv/vendors/datatables.net-bs4/dataTables.bootstrap4.js"></script>
  <script src="/themendv/js/dataTables.select.min.js"></script>

  <!-- End plugin js for this page -->
  <!-- inject:js -->
  <script src="/themendv/js/off-canvas.js"></script>
  <script src="/themendv/js/hoverable-collapse.js"></script>
  <script src="/themendv/js/template.js"></script>
  <script src="/themendv/js/settings.js"></script>
  <script src="/themendv/js/todolist.js"></script>
  <!-- endinject -->
  <!-- Custom js for this page-->
  <script src="/themendv/js/dashboard.js"></script>
  <script src="/themendv/js/Chart.roundedBarCharts.js"></script>
