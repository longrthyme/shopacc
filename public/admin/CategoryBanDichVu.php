<?php
    ...
    $title = 'QUẢN LÝ CHUYÊN MỤC VẬT PHẨM | '.$NDVMEDIA->site('tenweb');
...
if(isset($_POST['ThemChuyenMuc']) && $getUser['level'] == 'admin' )
{
    ...
    $NDVMEDIA->insert("category_bandv", array(
        ...
        <div class="content-wrapper">
          <div class="row">
           <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">THÊM DANH MỤC TOILET</h4>
           ...
           <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">DANH SÁCH CHUYÊN MỤC BÁN VẬT PHẨM</h4>
                  <p class="card-description">
                        ...
                        <div class="table-responsive">
                            <table id="datatable1" class="table table-bordered table-striped table-hover">
                                ...
                                <tbody>
                                    <?php
                                    $i = 0;
                                    foreach($NDVMEDIA->get_list(" SELECT * FROM `category_bandv` ORDER BY id DESC ") as $row){
                                    ?>
                                    <tr>
                                        <td><?=$i++;?></td>
                                        ...
                                        <td>
                                            ...
                                            <a type="button"
                                                href="<?=BASE_URL('public/admin/GroupsVatPham.php?id=');?><?=$row['id'];?>"
                                                class="btn btn-info"><i class="fas fa-file-medical"></i>
                                                <span>XEM NHÓM</span></a>

                                            <a class="btn btn-primary" href="<?=BASE_URL('public/admin/EditCategoryVatPham.php?id=');?><?=$row['id'];?>"><i
                                                    class="fas fa-edit"></i>
                                                <span>EDIT</span></a>
...
$(".delete").on("click", function() {
    cuteAlert({
        ...
        if (e) {
            $.ajax({
                url: "<?=BASE_URL("assets/ajaxs/admin/delete-category-vatpham.php");?>",
                method: "POST",
                dataType: "JSON",
                data: {
                    id: $(this).data('id')
